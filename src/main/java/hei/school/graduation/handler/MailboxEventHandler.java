package hei.school.graduation.handler;

import static hei.school.graduation.concurrency.ThreadRenamer.renameWorkerThread;
...
import hei.school.graduation.PojaApplication;
import hei.school.graduation.PojaGenerated;
import hei.school.graduation.endpoint.EndpointConf;
import hei.school.graduation.endpoint.event.EventConf;
import hei.school.graduation.endpoint.event.consumer.EventConsumer;
import hei.school.graduation.endpoint.event.consumer.model.ConsumableEvent;
import hei.school.graduation.endpoint.event.consumer.model.ConsumableEventTyper;
