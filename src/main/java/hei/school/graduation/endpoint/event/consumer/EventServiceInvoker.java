package hei.school.graduation.endpoint.event.consumer;

import hei.school.graduation.PojaGenerated;
import hei.school.graduation.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("hei.school.graduation.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "hei.school.graduation.service.event."
