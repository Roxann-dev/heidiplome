package hei.school.graduation.endpoint.event.model;

import static hei.school.graduation.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import hei.school.graduation.PojaGenerated;
import hei.school.graduation.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "hei.school.graduation.event1";
  }
}
